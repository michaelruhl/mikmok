...
const handlePost = async () => {
  ...
  return (
    <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        ...
        flex gap-6 w-[60%] flex-wrap justify-between items-center p-14 pt-6'>
            <div className=''>
                <div> 
                ...
                hover:border-red-300 hover:bg-gray-100'>
                    ...
                    {wrongFileType && (
                        ...
                        text-red-400 font-semibold mt-4 w-[250px]'>
                ...
                <div className='flex flex-col gap-3 pb-10'>
                    ...
                    text-md border-2 border-gray-200 p-2"
                    />
                    <label className='text-md font-medium'>
                        Choose a Category
                    </label>
                    ...
                    bg-white text-gray-700 text-md p-2 hover:bg-slate-300'
                    >
                        {topics.map((topic) => (
                            <option
                            value={topic.name}
                            key={topic.name}
                            className='outline-none capitalize bg-white trxt-gray-700 
